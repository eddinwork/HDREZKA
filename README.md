...
![version](https://img.shields.io/badge/version-1.4.2-blue) ![platform](https://img.shields.io/badge/platform-Windows%2010%2F11%20x64-lightgrey) ![license](https://img.shields.io/badge/license-MIT-green)
...
Вариант 1 — установщик: скачайте `HDREZKA-Setup-1.4.2.exe` из раздела [Releases](../../releases), запустите и укажите папку. Ярлыки появятся в меню «Пуск» (и на рабочем столе — опционально).

Вариант 2 — portable: скачайте `HDREZKA-1.4.2-portable-win-x64.zip`, распакуйте и запустите `HDREZKA.App.exe`. Настройки хранятся в `%AppData%/HDREZKA`.
