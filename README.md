...
- **Видеоплеер** — нативное воспроизведение в отдельном окне, полноэкранный режим, качество, субтитры, скорость, zoom, запоминание позиции
- **Досмотреть** — локальная история + синхронизация с аккаунтом, удаление записей
...
- **Персонализация** — тема (системная/светлая/тёмная), язык (русский/English/українська), размер постеров, зеркало сайта
