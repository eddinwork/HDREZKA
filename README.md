...
![version](https://img.shields.io/badge/version-1.3.0-blue) ![platform](https://img.shields.io/badge/platform-Windows%2010%2F11%20x64-lightgrey) ![license](https://img.shields.io/badge/license-MIT-green)
...
- **Досмотреть** — локальная история + синхронизация с аккаунтом, удаление записей, ряд «Продолжить просмотр» на главной, сортировка новые/старые
- **Просмотрено** — отметки о просмотре для фильмов и серий, работают даже без аккаунта
- **Уведомления** — отслеживание сериалов, тосты и вкладка о новых сезонах и сериях
